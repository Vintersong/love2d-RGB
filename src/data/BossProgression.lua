...
local TIERS = {
    {
        ...
        attack = {"single_shot", "spread_cone"},
...
local function scaledTier(index)
    ...
    local healthScale = 1 + cycle * 0.42
    local damageScale = 1 + cycle * 0.16
    local speedScale = 1 + cycle * 0.08
    local rateScale = math.max(0.72, 1 - cycle * 0.06)
