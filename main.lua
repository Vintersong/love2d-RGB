...
-- Game states
local SplashScreen = require("src.states.boot.SplashScreenState")
local MenuState = require("src.states.menu.MenuState")
local PlayingState = require("src.states.gameplay.PlayingState")
local LevelUpState = require("src.states.gameplay.LevelUpState")
local GameOverState = require("src.states.outcome.GameOverState")
local VictoryState = require("src.states.outcome.VictoryState")
local PauseState = require("src.states.gameplay.PauseState")
local UISandboxState = require("src.states.overlay.UISandboxState")
local OptionsState = require("src.states.menu.OptionsState")
local LoadingState = require("src.states.boot.LoadingState")
local TutorialState = require("src.states.menu.TutorialState")
local AtlasState = require("src.states.menu.AtlasState")
local ProgressionState = require("src.states.menu.ProgressionState")
local ConfirmState = require("src.states.overlay.ConfirmState")
local RunSummaryState = require("src.states.outcome.RunSummaryState")
...
function love.load(args)
    ...
    BootLoader.registerSystem("UIAnimator", UIAnimator, {"new"})
